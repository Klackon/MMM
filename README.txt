...
6. Choose a game scenes, click on the start button on top of unity to start the game.
...
Game features:
Once you start the "Game" Scenes, press the "enter" key, then you will be able to move the player on the game board.
